...
| [ ] | 4 | Create the buildout dependency and evidence matrix | 3 checked | Every buildout has prerequisites, commands, evidence, and a decision gate | [Companion specification gate](PRODUCT_ROADMAP.md#companion-specification-gate) |
