...
from . import calculations, gateway, inventory, models, topology, values, workflow
...
def _public_contract_types() -> tuple[type[object], ...]:
    ...
    for module in (values, models, inventory, topology, gateway, calculations, workflow):
